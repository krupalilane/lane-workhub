...
<?php } ?>
<form id="register-form" action="<?php echo site_url('register/save_user');?>" method="post">
    ...
    <div class="form-group">
        <label class="control-label" for="localoffice">Choose Local Lane Office</label>
...
<script>
    var check_email_url = "<?php echo site_url('register/check_email');?>";
</script>