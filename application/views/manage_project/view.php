                            ...
                            <div class="portlet-title">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <a class="btn red" href="<?php echo site_url('manage_project');?>">Back To Projects</a>
                                    </div>
                                </div> 
                            </div>
                        </div>
                                                                        ...
                                                                        if ($product_file_data) {
                                                                            foreach ($product_file_data as $key => $file_data) { ?>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td> <a class="btn btn-xs red" target="_blank" href="<?php echo site_url('manage_project/download_file/'.$file_data->id); ?>">Download File</a> </td>
                                                                                    </tr>
                                                                            <?php }
                                                                        } ?>
                                                                    </tbody>
